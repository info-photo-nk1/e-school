...
エキサイティングな3Dモデリングの世界への旅を始めましょう！`,
    ...
    "1-2": {
      ...
      content: `# Blenderインターフェースのナビゲーション

## Blenderのデフォルトレイアウト

Blenderを初めて開くと、いくつかのエリアが表示されます：

### 1. 3Dビューポート（中央）
- ここで作業の大部分を行います
- 異なる角度から3Dシーンを表示
- デフォルトのキューブ、カメラ、ライトが含まれています
...
### マウスナビゲーション
- **中マウスボタン + ドラッグ**: ビューの回転
- **Shift + 中マウス + ドラッグ**: ビューのパン
- **スクロールホイール**: ズームイン/アウト

### キーボードショートカット
- **テンキー 1, 3, 7**: 正面、右、上面ビュー
- **テンキー 5**: 正投影/透視投影の切り替え
- **Home**: すべてのオブジェクトを枠内に収める
- **テンキー Period**: 選択したオブジェクトを枠内に収める
...
これらのナビゲーション技術を練習してください - すぐに慣れるでしょう！`
    },
    "1-3": {
